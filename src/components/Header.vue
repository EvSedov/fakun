<template>
  ...
  >
    <div
      class="container mx-auto flex justify-between sm:justify-around items-center flex-wrap"
    >
      <!-- Разделы навигации -->
      ...
      >
        <a
          ...
          class="flex items-center space-x-2 text-white font-prosto text-xl sm:text-[17px] hover:text-[#72C95E] transition"
        >
          <svg
            width="18"
            height="18"
        ...
        <div class="flex space-x-3 justify-center items-center">
          ...
          <a
            ...
            target="_blank"
            class="flex justify-center items-center text-white transition text-lg w-8 h-8 sm:w-5 sm:h-5"
          >
            <svg
              width="18"
              height="18"
              ...
              fill="#FFFFFF"
              xmlns="http://www.w3.org/2000/svg"
              class="hover:fill-[#72C95E] scale-150 sm:scale-100"
            >
              <path
          ...
          <a
            ...
            target="_blank"
            class="flex justify-center items-center text-white transition text-lg w-8 h-8 sm:w-5 sm:h-5 hover:text-[#72C95E]"
          >
            <svg
              width="18"
              height="18"
      ...
      <div class="md:hidden flex items-center">
        ...
        >
          ...
          <DrawerContent class="bg-[#2A2A2A]">
            ...
            <nav>
              <ul
                class="flex flex-col space-y-4 p-4 text-[#72C95E] font-prosto text-[17px]/13 uppercase font-bold"
              >
                <li>
                  <a
                    href="#about"
